...
var serviceApi = builder.AddProject<Projects.KoiShopTravel_DeliveryDetailServicce>("apiservice-service");
...
builder.AddProject<Projects.KoiTravelShop_ServiceService>("koitravelshop-serviceservice");
